      ...
      <div className="container-fluid p-3 bg-white">
        <div className="row" >
          <div className="col-md-3" >
            <div className=' rounded shadow-lg d-none d-md-block' style={{ width: "350px", marginTop: "40px", position: "fixed", top: "80px", left: "20px"}} >
          ...
          <div className="col-md-9">
            <img src={bloodImg} alt="" className=' w-100' style={{height:"600px",marginTop:"100px"}}/>
            <div  id='About' >
